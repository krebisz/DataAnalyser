...
public sealed record MetricIdentityResolutionResult
{
    ...
    public static MetricIdentityResolutionResult Failed(IdentityResolutionFailureReason reason, IReadOnlyList<string>? diagnostics = null)
    {
    ...
    public static MetricIdentityResolutionResult Succeeded(CanonicalMetricId metricId)
    {
        return new MetricIdentityResolutionResult
        {
                Success = true,
