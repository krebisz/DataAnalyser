...
public static class SamsungHealthCsvParser
{
    ...
    private static List<HealthMetric> ParseCsvRow(List<string> headers, List<string> values, string filePath, string metricType, string metricIdentifierForFields)
    {
        ...
        foreach (var kvp in rowData)
        {
            ...
            if (fieldName.Contains("time", StringComparison.OrdinalIgnoreCase) || fieldName.Contains("date", StringComparison.OrdinalIgnoreCase) || fieldName.Contains("uuid", StringComparison.OrdinalIgnoreCase) || fieldName.Contains("source", StringComparison.OrdinalIgnoreCase) || fieldName.Contains("tag_id", StringComparison.OrdinalIgnoreCase) || fieldName.Contains("binning_data", StringComparison.OrdinalIgnoreCase) || fieldName.Contains("comment", StringComparison.OrdinalIgnoreCase) || fieldName.Contains("pkg_name", StringComparison.OrdinalIgnoreCase) || fieldName.Contains("deviceuuid", StringComparison.OrdinalIgnoreCase) || fieldName.Contains("datauuid", StringComparison.OrdinalIgnoreCase) || fieldName.Contains("time_offset", StringComparison.OrdinalIgnoreCase) || fieldName.Contains("create_sh_ver", StringComparison.OrdinalIgnoreCase) || fieldName.Contains("modify_sh_ver", StringComparison.OrdinalIgnoreCase) || fieldName.Contains("custom", StringComparison.OrdinalIgnoreCase))
                continue;

            // Try to parse as numeric value
            if (decimal.TryParse(fieldValue, NumberStyles.Any, CultureInfo.InvariantCulture, out var numericValue))
            {
