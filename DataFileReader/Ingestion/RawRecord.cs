...
{
    public RawRecord(string sourceId, IReadOnlyDictionary<string, object?> fields, DateTimeOffset? rawTimestamp = null, string? sourceGroup = null, IReadOnlyDictionary<string, string>? metadata = null)
    {
