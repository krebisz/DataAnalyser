...
public sealed class ArchitectureGuardrailTests
{
    ...
    public void OperationChainWorkbench_ShouldKeepExecutionOutsideUiSurface()
    {
        ...
        Assert.Contains("TransformWorkbenchPresenter.Build(result)", viewSource, StringComparison.Ordinal);
        Assert.Contains("TransformWorkbenchService", viewSource, StringComparison.Ordinal);
        Assert.Contains("TransformComputationOutputRenderer", viewSource, StringComparison.Ordinal);
        Assert.Contains("TransformComputationResultProjector.FromOperationChainResult(result)", viewSource, StringComparison.Ordinal);
        ...
        Assert.DoesNotContain("OperationChainEvidenceExportService", viewSource, StringComparison.Ordinal);
        Assert.DoesNotContain("TransformOperationChain", viewSource, StringComparison.Ordinal);
