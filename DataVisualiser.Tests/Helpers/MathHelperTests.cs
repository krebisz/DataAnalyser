...
namespace DataVisualiser.Tests.Helpers
{
    public sealed class MathHelperTests
    {
        ...
        public void MapTimestampToIntervalIndex_ShouldReturnValidIndex()
        {
            ...
            var index = MathHelper.MapTimestampToIntervalIndex(
        ...
        {
            var values = new List<double> { 10, 20, 40 };
        ...
        {
            var first = new List<double> { 50, 100 };
            var second = new List<double> { 100, 100 };

            var (relative, baseline) =
                MathHelper.ReturnValueNormalized(first, second, NormalizationMode.RelativeToMax);
        ...
        {
            var values = new List<double> { double.NaN, 10.0 };
