        ...
        await StaTestHelper.RunAsync(async () =>
        {
            ...
            try
            {
                ...
                await coordinator.UpdateChartUsingStrategyAsync(
                    chart,
                    new StubStrategy(CreateSingleSeriesResult()),
                    new ChartUpdateRequest { PrimaryLabel = "Primary", MetricType = "Weight", UseRenderPlanAdapter = true });
                await FlushChartAsync(chart);
        ...
        await StaTestHelper.RunAsync(async () =>
        {
            ...
            try
            {
                ...
                await coordinator.UpdateChartUsingStrategyAsync(
                    chart,
                    new StubStrategy(CreateSingleSeriesResult()),
                    new ChartUpdateRequest { PrimaryLabel = "Primary", MetricType = "Weight", OverlaySeries = [CreateOverlaySeriesResult()], UseRenderPlanAdapter = true });
                await FlushChartAsync(chart);
