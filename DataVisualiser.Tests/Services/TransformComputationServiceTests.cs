...
using DataVisualiser.Services.Transform;
...
namespace DataVisualiser.Tests.Services
{
    ...
    public sealed class TransformComputationServiceTests
    {
        ...
        public void ComputeUnaryTransform_ShouldReturnEmpty_WhenAllValuesAreNull()
        {
            ...
            {
                new() { NormalizedTimestamp = BaseDate, Value = null },
                new() { NormalizedTimestamp = BaseDate.AddDays(1), Value = null }
            };
        ...
        public void ComputeUnaryTransform_ShouldFilterNullValues()
        {
            ...
            var data = new List<HealthMetricData>
            {
                new() { NormalizedTimestamp = BaseDate, Value = 10m },
                new() { NormalizedTimestamp = BaseDate.AddDays(1), Value = null },
                new() { NormalizedTimestamp = BaseDate.AddDays(2), Value = 20m }
            };
        ...
        public void ComputeBinaryTransform_ShouldAlignDataByTimestamp()
        {
            ...
            {
                new() { NormalizedTimestamp = BaseDate.AddDays(1), Value = 5m },
                new() { NormalizedTimestamp = BaseDate.AddDays(2), Value = 15m }
            };
        ...
        public void ComputeBinaryTransform_ShouldReturnEmpty_WhenNoOverlappingTimestamps()
        {
            ...
            var data2 = new List<HealthMetricData>
            {
                new() { NormalizedTimestamp = BaseDate.AddDays(10), Value = 5m }
            };
