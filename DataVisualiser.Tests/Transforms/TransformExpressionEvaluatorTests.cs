...
public sealed class TransformExpressionEvaluatorTests
{
    ...
    {
        var a = Series((new DateTime(2024, 1, 1), 1m), (new DateTime(2024, 1, 2), 2m), (new DateTime(2024, 1, 3), 3m));

        var b = Series((new DateTime(2024, 1, 2), 20m), (new DateTime(2024, 1, 3), 30m), (new DateTime(2024, 1, 4), 40m));
