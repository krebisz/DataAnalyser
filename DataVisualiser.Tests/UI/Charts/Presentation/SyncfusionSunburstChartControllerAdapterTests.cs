...
public sealed class SyncfusionSunburstChartControllerAdapterTests
{
    ...
    private static ( MainWindowViewModel ViewModel, DataVisualiser.Core.Services.MetricSelectionService MetricService) CreateViewModel()
    {
        var chartState = new ChartState();
        var metricState = new MetricState();
        var uiState = new UiState();
        var metricService = new DataVisualiser.Core.Services.MetricSelectionService("TestConnection");
