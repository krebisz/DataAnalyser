...
public sealed class SingleMetricCmsStrategy : IChartComputationStrategy
{
    ...
    public SingleMetricCmsStrategy(ICanonicalMetricSeries cms, string label, DateTime from, DateTime to, ITimelineService? timelineService = null, ISmoothingService? smoothingService = null)
    {
    ...
    public ChartComputationResult? Compute()
    {
        ...
        var samples = _cms.Samples.Where(s => s.Value.HasValue).
            Select(s => new
            {
        ...
        var timestamps = samples.Select(s => s.Timestamp).
            ToList();
        ...
        var syntheticData = samples.Select(s => new HealthMetricData
            {
        ...
        return new ChartComputationResult
        {
            ...
            PrimaryRawValues = samples.Select(s => s.ValueDouble).
                ToList(),
