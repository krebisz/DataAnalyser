...
/// </summary>
public sealed record FrequencyShadingData(List<(double Min, double Max)> Intervals, Dictionary<int, Dictionary<int, int>> FrequenciesPerBucket, Dictionary<int, Dictionary<int, Color>> ColorMap, Dictionary<int, List<double>> BucketValues)
{
