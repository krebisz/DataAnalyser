...
namespace DataVisualiser.Services.Implementations
{
    ...
    {
        public IReadOnlyList<HealthMetricData> PrepareLegacyData(
        ...
        public IReadOnlyList<MetricSample> PrepareCmsData(
            ...
            DateTime to)
        {
            ...
            return cms.Samples
                .Where(s => s.Value.HasValue
                         && s.Timestamp.DateTime >= from
                         && s.Timestamp.DateTime <= to)
                .OrderBy(s => s.Timestamp)
                .ToList();
        }

        public IReadOnlyList<HealthMetricData> ConvertCmsToLegacy(
            ICanonicalMetricSeries cms,
            DateTime from,
            DateTime to)
        {
        ...
        public bool ValidateLegacyData(IReadOnlyList<HealthMetricData> data)
        {
            ...
            return data.All(d => d != null
                              && d.Value.HasValue
                              && d.NormalizedTimestamp != default);
        }
