...
namespace DataVisualiser.UI
{
    ...
    public partial class ChartPanelController : UserControl
    {
        public static readonly DependencyProperty TitleProperty =
            DependencyProperty.Register(nameof(Title), typeof(string), typeof(ChartPanelController),
                new PropertyMetadata("Chart", OnTitleChanged));

        public static readonly DependencyProperty IsChartVisibleProperty =
            DependencyProperty.Register(nameof(IsChartVisible), typeof(bool), typeof(ChartPanelController),
                new PropertyMetadata(false, OnVisibilityChanged));

        public static readonly DependencyProperty HasBehavioralControlsProperty =
            DependencyProperty.Register(nameof(HasBehavioralControls), typeof(bool), typeof(ChartPanelController),
                new PropertyMetadata(false));

        public static readonly DependencyProperty RenderingContextProperty =
            DependencyProperty.Register(nameof(RenderingContext), typeof(IChartRenderingContext), typeof(ChartPanelController),
                new PropertyMetadata(null, OnRenderingContextChanged));
