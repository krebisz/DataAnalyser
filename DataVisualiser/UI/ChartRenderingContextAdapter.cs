...
namespace DataVisualiser.UI
{
    ...
    public class ChartRenderingContextAdapter : IChartRenderingContext
    {
        ...
        public ChartRenderingContextAdapter(
            ChartState chartState,
            Func<ChartDataContext?> getCurrentContext,
            Func<ChartDataContext?, bool> hasSecondaryData,
            Func<ChartDataContext?, bool> shouldRenderCharts)
        {
            ChartState = chartState;
