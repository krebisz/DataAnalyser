...
/// </summary>
public sealed class HourlyDistributionParityHarness : IStrategyParityHarness
{
    ...
    private static IReadOnlyList<ParitySeries> BuildParitySeries(HourlyDistributionResult? ext)
    {
        ...
        // Synthetic "week index" timeline (12AM - 11PM)
        var baseDate = new DateTime(2000, 01, 03, 0, 0, 0, DateTimeKind.Unspecified);
