...
_Auto-generated. Heuristic, structural only. Do not edit by hand._
...
**Uses Namespaces:**
- System (common)
- static DataFileReader.Helper.DataHelper
...
- DataFileReader.Class
- Newtonsoft.Json
- var deleteCmd = new SqlCommand(deleteSql.ToString(), sqlConnection)
- var insertCmd = new SqlCommand(sql.ToString(), sqlConnection)
...
**Uses Namespaces:**
- System (common)
- DataVisualiser.Models; // where NormalizationMode is defined
...
- DataVisualiser.UI.SubtypeSelectors
- DataVisualiser.ViewModels
- DataVisualiser.ViewModels.Events
- LiveCharts.Defaults
- LiveCharts.Wpf
...
- DataVisualiser.Services
- DataVisualiser.State
- DataVisualiser.ViewModels.Commands
- DataVisualiser.ViewModels.Events

## Aggregated Dependency Views
